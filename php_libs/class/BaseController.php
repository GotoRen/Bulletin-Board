...
class BaseController {
    ...
    protected function view_display(){
        ...
        $this->view->display($this->file); // Smartyのdisplayメソッドを使用して表示
        //echo $this->file;
    ...
    public function make_page_link($data){
        ...
        $data  = $pager->getPageData(); // Pager_Jumpingクラスのメソッドを使用する
        $links = $pager->getLinks();    // Pager_Jumpingクラスのメソッドを使用する
        return [$data, $links];
    }    
